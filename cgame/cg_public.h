...
// 
// 50    9/18/00 6:00p Aldie
// Periodic update for FakkArena deathmatch code.
// 
// 49    9/01/00 7:09p Aldie
// More fakk arena work
// 
// 48    8/30/00 6:35p Aldie
...
typedef struct 
   ...
   void           (*Cmd_Stuff)( const char *cmd );
   void           (*Cmd_Execute)( int when, const char *cmd );
