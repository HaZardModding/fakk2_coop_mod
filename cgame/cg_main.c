...
void CTF_CahceRewardIcons(void);
void CTF_AddItemInfo(const char*, qhandle_t);
//Y
...
//Yorvik
cvar_t* ui_hud					= NULL;
cvar_t* cg_draw2D				= NULL;
cvar_t* cg_drawCrosshairNames	= NULL;
cvar_t* cg_drawTeamOverlay		= NULL;
cvar_t* cg_drawFPS				= NULL;
cvar_t* cg_drawPing				= NULL;
cvar_t* cg_drawTime				= NULL;
cvar_t* g_gametype				= NULL;
//Y
...
void CG_RegisterCvars( void ) 
   ...
   cvar_t * temp;
	...
	//Yorvik
		ui_hud					= cgi.Cvar_Get("ui_hud",				"",		0);
		cg_draw2D				= cgi.Cvar_Get("cg_draw2D",				"1",	CVAR_ARCHIVE);
		cg_drawTeamOverlay		= cgi.Cvar_Get("cg_drawTeamOverlay",	"1",	CVAR_ARCHIVE);
		cg_drawCrosshairNames	= cgi.Cvar_Get("cg_drawCrosshairNames",	"1",	CVAR_ARCHIVE);
		cg_drawFPS				= cgi.Cvar_Get("cg_drawFPS",			"1",	CVAR_ARCHIVE);
		cg_drawPing				= cgi.Cvar_Get("cg_drawPing",			"0",	CVAR_ARCHIVE);
		cg_drawTime				= cgi.Cvar_Get("cg_drawTime",			"1",	CVAR_ARCHIVE);
		g_gametype				= cgi.Cvar_Get("g_gametype",			"2",	CVAR_ARCHIVE);
		cg_lagometer			= cgi.Cvar_Get("cg_lagometer",			"1",	CVAR_ARCHIVE);
	//Y
...
void CG_PrepRefresh( void )
   ...
   //Yorvik - register ctf shaders

		//register flag shaders
		cgs.media.CTFFlagShaders[0]			= cgi.R_RegisterShaderNoMip("textures/hud/flag_home_r");
		cgs.media.CTFFlagShaders[1]			= cgi.R_RegisterShaderNoMip("textures/hud/flag_dropped_r");
		cgs.media.CTFFlagShaders[2]			= cgi.R_RegisterShaderNoMip("textures/hud/flag_gone_r");
		cgs.media.CTFFlagShaders[3]			= cgi.R_RegisterShaderNoMip("textures/hud/flag_home_b");
		cgs.media.CTFFlagShaders[4]			= cgi.R_RegisterShaderNoMip("textures/hud/flag_dropped_b");
		cgs.media.CTFFlagShaders[5]			= cgi.R_RegisterShaderNoMip("textures/hud/flag_gone_b");

		//hud graphics
		cgs.media.ui_healthicon				= cgi.R_RegisterShaderNoMip("textures/hud/healthicon");		
		cgs.media.ui_watericon				= cgi.R_RegisterShaderNoMip("textures/hud/watericon");
		cgs.media.ui_watericon_tiny			= cgi.R_RegisterShaderNoMip("textures/hud/watericon_tiny");
		cgs.media.ui_healthicon_tiny		= cgi.R_RegisterShaderNoMip("textures/hud/healthicon_tiny");
		cgs.media.ui_healthicon_tiny_low	= cgi.R_RegisterShaderNoMip("textures/hud/healthicon_tiny_low");
		cgs.media.ui_healthicon_tiny_dead	= cgi.R_RegisterShaderNoMip("textures/hud/healthicon_tiny_dead");
		cgs.media.unEvenTeamWarning			= cgi.R_RegisterShaderNoMip("textures/hud/teamwarn");
		cgs.media.hudbar					= cgi.R_RegisterShaderNoMip("textures/hud/hudbar.tga");
		cgs.media.ui_gunclip				= cgi.R_RegisterShaderNoMip("textures/hud/clip.tga");

		//scoreboard
		cgs.media.sb_lfade					= cgi.R_RegisterShaderNoMip("textures/ui/scoreboard/lfade.tga");
		cgs.media.sb_rfade					= cgi.R_RegisterShaderNoMip("textures/ui/scoreboard/rfade.tga");

		//register fonts
		cgs.media.ui_charset				= cgi.R_RegisterShaderNoMip("textures/hud/font_bigchars.tga");
		cgs.media.ui_numset					= cgi.R_RegisterShaderNoMip("textures/hud/font_bignumbers.tga");

		//head icons
		cgs.media.teamarrow					= cgi.R_RegisterModel("float_teamarrow.spr");
		cgs.media.capture					= cgi.R_RegisterModel("float_capture.spr");
		cgs.media.defend					= cgi.R_RegisterModel("float_defend.spr");
		cgs.media.assist					= cgi.R_RegisterModel("float_assist.spr");

		//lagometer
		cgs.media.lagometerShader			= cgi.R_RegisterShaderNoMip("textures/hud/lag.tga");
		cgs.media.lagometerError			= cgi.R_RegisterShaderNoMip("textures/hud/lagometer_err");

		//head reward icons
		CTF_CahceRewardIcons();

		//generic pickup icons
		CTF_AddItemInfo("ammo",		cgi.R_RegisterShaderNoMip("textures/hud/pickup_icons/ammo.tga"));
		CTF_AddItemInfo("weapon",	cgi.R_RegisterShaderNoMip("textures/hud/pickup_icons/weapon.tga"));
		CTF_AddItemInfo("item",		cgi.R_RegisterShaderNoMip("textures/hud/pickup_icons/item.tga"));
		CTF_AddItemInfo("flag",		cgi.R_RegisterShaderNoMip("textures/hud/pickup_icons/flag.tga"));
		CTF_AddItemInfo("tech",		cgi.R_RegisterShaderNoMip("textures/hud/pickup_icons/tech.tga"));
	//Y
