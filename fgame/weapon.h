...
class Weapon : public Item
	...
	private:
		...
		//Yorvik
		bool	m_gotForcedStartAmmo[MAX_FIREMODES];
		int		m_forcedStartAmmo[MAX_FIREMODES];

		virtual void SetForcedStartAmmo(Event* ev);
		virtual void SetForcedStartAmmoAlt(Event* ev);
