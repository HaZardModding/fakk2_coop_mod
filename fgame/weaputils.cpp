...
//Yorvik - HACK HACK - messed around with this a bit to fix some crashes
//that i couldnt find the cause of elsewhere.
void RadiusDamage
	(
	Entity   *inflictor,
	Entity   *attacker,
   ...
   //ent = findradius( NULL, inflictor->origin, rad );
	...
	for(int i=0; i<MAX_GENTITIES; ++i)
		...
		if(!ent || !ent->edict->inuse || !CTF::DistanceLess(ent->origin, inflictor->origin, rad))
			continue;
