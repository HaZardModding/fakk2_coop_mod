...
//Yorvik - CTF CVARS
cvar_t*		capturelimit		= NULL;
cvar_t*		sv_forcerespawn		= NULL;
cvar_t*		sv_motd				= NULL;
cvar_t*		sv_autoAim			= NULL;
cvar_t*		sv_maxFallingDamage	= NULL;

cvar_t*		g_singleTech		= NULL;
cvar_t*		g_friendlyFire		= NULL;
cvar_t*		g_teamAutoJoin		= NULL;
cvar_t*		g_teamForceBalance	= NULL;
cvar_t*		g_allowVote			= NULL;
cvar_t*		g_knockBack			= NULL;
cvar_t*		g_suddenDeath		= NULL;
//Y
...
void CVAR_Init
   ...
   {
	//Yorvik - CTF CVAR INITIALISATION
	capturelimit		= gi.cvar("capturelimit",		"0",	CVAR_SERVERINFO | CVAR_ARCHIVE);
	sv_forcerespawn		= gi.cvar("sv_forcerespawn",	"0",	CVAR_SERVERINFO | CVAR_ARCHIVE);
	sv_motd				= gi.cvar("sv_motd",			"",		CVAR_SERVERINFO);
	sv_autoAim			= gi.cvar("sv_autoAim",			"0",	CVAR_SERVERINFO | CVAR_ARCHIVE);
	sv_maxFallingDamage	= gi.cvar("sv_maxFallingDamage","9999",	CVAR_SERVERINFO | CVAR_ARCHIVE);

	g_friendlyFire		= gi.cvar("g_friendlyFire",		"0",	CVAR_SERVERINFO | CVAR_ARCHIVE);
	g_teamAutoJoin		= gi.cvar("g_teamAutoJoin",		"0",	CVAR_SERVERINFO | CVAR_ARCHIVE);
	g_teamForceBalance	= gi.cvar("g_teamForceBalance",	"0",	CVAR_SERVERINFO | CVAR_ARCHIVE);
	g_allowVote			= gi.cvar("g_allowVote",		"1",	CVAR_SERVERINFO | CVAR_ARCHIVE);
	g_knockBack			= gi.cvar("g_knockBack",		"0.2",	CVAR_SERVERINFO | CVAR_ARCHIVE);
	g_singleTech		= gi.cvar("g_singleTech",		"0",	CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_LATCH);
	g_suddenDeath		= gi.cvar("g_suddenDeath",		"5",	CVAR_SERVERINFO | CVAR_ARCHIVE);
	//Y

	developer			   = gi.cvar( "developer",             "0",     0 );
   precache 			   = gi.cvar( "sv_precache",           "1",     0 );
	dedicated			   = gi.cvar( "dedicated",             "0",     CVAR_ROM );
	deathmatch			   = gi.cvar( "deathmatch",            "0",     CVAR_SERVERINFO|CVAR_LATCH );
	skill					   = gi.cvar( "skill",                 "1",     CVAR_SERVERINFO|CVAR_LATCH );
	maxclients			   = gi.cvar( "sv_maxclients",         "16",     CVAR_ARCHIVE ); //Yorvik - made this archived & default to 16
	maxentities			   = gi.cvar( "maxentities",           "1024",  CVAR_LATCH );
	password             = gi.cvar( "password",              "",      CVAR_USERINFO );
	filterban            = gi.cvar( "filterban",             "1",     0 );
	dmflags				   = gi.cvar( "dmflags",               "0",     CVAR_SERVERINFO );
	fraglimit			   = gi.cvar( "fraglimit",             "0",     CVAR_SERVERINFO | CVAR_ARCHIVE ); //Yorvik
	timelimit			   = gi.cvar( "timelimit",             "0",     CVAR_SERVERINFO | CVAR_ARCHIVE ); //Made these archived
	nomonsters			   = gi.cvar( "nomonsters",            "1",     CVAR_SERVERINFO ); //Yorvik - no monsters default to 1
   ...
   switch ( g_gametype->integer )
      ...
      case GT_ARENA:
		...
		// Wilka
	  case GT_CTF:
         gi.cvar_set( "g_gametypestring", "ctf" );
         break;
