...
//Yorvik - this holds any changes to tech status - eg pickup
#define CS_TECHINFO			13
#define CS_MAPLOCATIONS		14
//Y
...
#define  CS_NUM_ARENAS        (CS_AMMO+MAX_AMMO)
...
//Yorvik - CTF entity flags
#define EF_CTF_CAPTURE			(1<<8)
#define EF_CTF_DEFEND			(1<<9)
#define EF_CTF_ASSIST			(1<<10)

#define EF_CTF_CONSOLE			(1<<20)
#define EF_CTF_CONNECTIONERR	(1<<21)
//Y
...
typedef enum
   ...
   STAT_WATER_LEVEL,       // amount of water the player has
   ...
   STAT_KILLS,             // Number of kills				20
   STAT_DEATHS,            // Number of deaths				21
   STAT_TIMELEFT_MINUTES,  // Timeleft in minutes			22
   STAT_TIMELEFT_SECONDS,  // Timeleft in seconds			23
   
   //Yorvik - CTF stats
   STAT_FRAGS,			   // kills-deaths					24
   STAT_BLUESCORE,		   // blue team's score				25
   STAT_REDSCORE,		   // red team's score				26
   STAT_BLUEFLAGSTATUS,	   // status of blue team's flag	27
   STAT_REDFLAGSTATUS,	   // status of red team's flag		28
   STAT_GOTFLAG,		   // set when we have a flag		29
   STAT_CAPTURES,		   // how many caps we have			30
   //Y

   STAT_LAST_STAT          // Last stats
   } playerstat_t
   ;
...
//Yorvik
#define CTF_TECH_WARNING_TIME	  5.0f

#define CTF_TECH_NONE			  0
#define CTF_TECH_CLEAR_ALL		  -1
//Y
